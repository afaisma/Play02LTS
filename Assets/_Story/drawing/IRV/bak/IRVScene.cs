...
public class IRVScene: MonoBehaviour
{
    // protected List<IRVSprite> lsIrvsprites = new List<IRVSprite>(); //this list contains all sprites shown in the scene
    // public GameObject m_gameObjectRoot;
    // private Vector3 m_v3storedPosition;
    // private string m_sceneStatistics = "";
